...
// relevant to the function. In this case, msg and alertType for the view. Timeout = 4000 sets a default timeout
export const setAlert = (msg, alertType, timeout = 30000) => (dispatch) => {
